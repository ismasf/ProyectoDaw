...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-03-2016 a las 18:52:41
...
INSERT INTO `usuario` (`id`, `user`, `hash`, `nombre`, `apellidos`, `fechanacimiento`, `ciudad`, `verificado`) VALUES
(1, 'ismael', 'aaaa', 'Ismael', 'Nuñez Garcia', '1994-03-03', 'Madrid', 'NO'),
(2, 'ismael', 'aaaa', 'Ismael', 'Nuñez Garcia', '1994-03-03', 'Madrid', 'SI'),
(3, 'carlos_9349@hotmail.com', 'aaaaaa', 'carlos', 'garbajosa', '2015-03-11', 'madrid', 'NO');
