                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      Lista de Incidencias de Usuarios para atender.
                    </p>
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                      <?php foreach ($incidencias as $k):?>
                        <tr>
                          <td><?=$k["uniqid"]?></td>
                          <td><?=$k["problema"]?></td>
                          <td><?=$k["fecha_incidencia"]?></td>
                          <td><?=$k["estado"]?></td>
                          <td><button type="button" id="button.<?=$k["id"]?>" class="btn btn-success btn-sm" onclick="verIncidencia('<?=$k["uniqid"]?>')">Ver</button></td>
                        </tr>
