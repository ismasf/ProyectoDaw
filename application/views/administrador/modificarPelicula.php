                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      Lista de peliculas para modificar.
                    </p>
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <?php foreach ($peliculas as $k):?>
                        <tr>
                          ...
                          <td><?=$k["director"]?></td>
                          <td><?=$k["duracion"]?></td>
                          <td><a href="<?=base_url()?>administrador/modificarPeliculaGet/<?=$k["id"]?>"><button type="button" class="btn btn-success btn-sm">Modificar</button></a></td>
                        </tr>
