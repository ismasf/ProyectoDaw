<script>
  function activar(id){
    if(confirm("¿Quieres activar el usuario?")){
      window.location="<?=base_url()?>/administrador/activarUsuarioGet/"+id;
    }
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <?php foreach ($usuario as $k):?>
                        <tr>
                          ...
                          <td><?=$k["nombre"]?></td>
                          <td><?=$k["ciudad"]?></td>
                          <td><button type="button" class="btn btn-success btn-sm" onclick="activar(<?=$k["id"]?>)">activar</button></td>
                        </tr>
